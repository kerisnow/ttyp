...
public class ConsumeListActivity extends MyBaseActivity implements CustomDatePickerDialogFragment.OnSelectedDateListener{
    ImageView backImage;
    TextView title_text;
    TextView textView1;
    //    LinearLayout layout;
    ...
    private void setListener(){
        try{
            ...
            adapter = new DixkBListAdapter(ConsumeListActivity.this,R.layout.item_dixk_b,list);
